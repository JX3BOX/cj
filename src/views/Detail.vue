        ...
        <div class="m-wiki-post-panel" v-if="wiki_post && wiki_post.post">
            <WikiPanel :wiki-post="wiki_post">
                ...
                <template slot="body">
                    ...
                    <Thx class="m-thx" :postId="id" postType="achievement" :userId="author_id" :adminBoxcoinEnable="true" :userBoxcoinEnable="true" mode="wiki" :authors="authors" :key="'achievement-thx-' + id"/>
                </template>
            </WikiPanel>
