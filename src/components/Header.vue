<template>
    <header class="c-header" id="c-header">
        <!-- <button class="c-header-menu" id="c-header-menu"></button> -->
        ...
        <div class="c-header-inner">
            ...
            <div class="c-header-nav">
                <ul>
                    <li><a :href="JX3BOX.__channel_macro">宏库</a></li>
                    <li><a :href="JX3BOX.__channel_jx3dat">插件</a></li>
                    <li><a :href="JX3BOX.__channel_fb">副本</a></li>
                    <li><a :href="JX3BOX.__channel_bps">职业</a></li>
                    <li><a :href="JX3BOX.__channel_wiki">百科</a></li>
                    <li><a :href="JX3BOX.__channel_pvx">休闲</a></li>
                    <li><a :href="JX3BOX.__channel_bbs">茶馆</a></li>
                    <li><a :href="JX3BOX.__channel_app">应用</a></li>
                </ul>
            </div> 
                ...
                <div class="c-header-msg" id="c-header-msg">
                    ...
                    <a
                        ...
                        ><i class="u-icon u-icon-msg"
                            ><img svg-inline src="../assets/img/msg.svg"/></i
                    ></a>
                    <div
                        class="u-list"
                        style="display:none;"
